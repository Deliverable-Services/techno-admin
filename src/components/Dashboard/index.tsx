    ...
    <>
      <Container fluid className="component-wrapper px-0 py-2">
        ...
        <div className="dashboard-page w-100 mt-4">
          <Container fluid className="status-container mt-0">
            <div className="head-row">
              <div className="card p-2 d-flex">
                <div className="d-flex flex-column">
                  <div className="lead">Customers</div>
                  <div className="d-flex align-items-end">
                    <p className=" display-4 text-primary m-0 font-weight-bold">
              ...
              <div className="card p-2 d-flex">
                <div className="d-flex flex-column">
                  <div className="lead">Merchants</div>
                  <div className="d-flex align-items-end">
                    <p className=" display-4 text-primary m-0 font-weight-bold">
