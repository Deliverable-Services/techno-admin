  ...
  return (
    <>
      <Container fluid className="component-wrapper view-padding">
        <PageHeading icon={<FaAddressCard />} title="Subscriptions" totalRecords={data?.total} />
        ...
        {data?.data?.length > 0 ?
          ...
          :
          <BillingIntegration title="Easily create invoices, subscriptions for each of your customers" description="Click on the below button to create your Stripe connect account which will let you raise invoices, or subscription to receive payments with ease." buttonLink="#" buttonText="Get Started" icon="/assets/billing.png" />}
      </Container>
