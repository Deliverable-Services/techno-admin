...
const TiptapTextEditor = ({ name, value = "", setFieldValue }: Props) => {
  ...
  return (
    <div>
      ...
      /> */}
      <div className="border border-input rounded-md px-3 py-2 min-h-[150px]">
        <EditorContent
          editor={editor}
          className="outline-none focus:outline-none focus:ring-0 focus-within:ring-0 focus-visible:outline-none"
        />
      </div>
    </div>
  );
