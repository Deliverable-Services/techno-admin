...
export const PrivateRoute = ({
  ...
  if (loggedInUser.organisations && !loggedInUser.organisations[0].hasOwnProperty("store_type")) loggedInUser.organisations.store_type = "crm"; // setting default to CRM if no organisation found
